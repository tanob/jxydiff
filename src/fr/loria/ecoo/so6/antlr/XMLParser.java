...
public XMLParser(ParserSharedInputState state) {
  ...
  tokenNames = _tokenNames;
			...
			case BOPEN:
			{
				...
				do {
					...
					case COMMENT:
					{
						comment = LT(1);
						match(COMMENT);
						t.appendContent("<!--");t.appendContent(comment.getText());t.appendContent("-->");
						break;
					}
					case PI_S:
					{
					...
					case CDATA:
					{
						cdata = LT(1);
						match(CDATA);
						t.appendContent("<!CDATA[");t.appendContent(cdata.getText());t.appendContent("]]>");
						break;
					}
					default:
					{
	...
	public final void text_wo_bracket(
		TextNode n
	...
	public final void long_suite(
		...
		if (!elt.getElementName().equals(s)) throw new ParseException("The tag name must be equal");
		{
		switch ( LA(1)) {
		case WS:
		{
	...
	private static final long[] mk_tokenSet_0() {
		long[] data = { 66438296178L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_0 = new BitSet(mk_tokenSet_0());
	private static final long[] mk_tokenSet_1() {
		long[] data = { 66438296176L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_1 = new BitSet(mk_tokenSet_1());
	private static final long[] mk_tokenSet_2() {
		long[] data = { 60532392000L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_2 = new BitSet(mk_tokenSet_2());
	private static final long[] mk_tokenSet_3() {
		long[] data = { 68586304114L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_3 = new BitSet(mk_tokenSet_3());
	private static final long[] mk_tokenSet_4() {
		long[] data = { 68586295888L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_4 = new BitSet(mk_tokenSet_4());
	private static final long[] mk_tokenSet_5() {
		long[] data = { 68586295904L, 0L};
		return data;
	}
